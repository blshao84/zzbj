...
public class OtherReportApi {

    private final OtherReportService otherReportService;

    @Autowired
    public OtherReportApi(OtherReportService otherReportService) {
    ...
    public List<OtherReportDTO> getDataSource() {
        return otherReportService.listOtherReport();
    }
    ...
    public Boolean executeTransTask() {
        return otherReportService.executeTransTask();
    }
    ...
    public Boolean modifyOtherReport(@RequestBody JsonRequest jsonRequest) {
        return otherReportService.updateReport(jsonRequest.getId(), jsonRequest.getParams());
    }
    ...
    public Boolean saveOtherReport(@RequestBody JsonRequestCollection jsonRequest) {
        return otherReportService.saveReport(jsonRequest.getParams());
    }
    ...
    public Boolean deleteOtherReport(@PathVariable String bizId) {
        return otherReportService.deleteReport(bizId);
    }
    ...
    public Boolean executeGenerateTask(@RequestParam("operation") String operation) {
        ...
        String dir = otherReportService.executeGenerateTask(operationEnum);
        //清空xml
