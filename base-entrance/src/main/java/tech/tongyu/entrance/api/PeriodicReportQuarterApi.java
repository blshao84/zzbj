 ...
 */
@RestController
@RequestMapping("pr-quarter")
public class PeriodicReportQuarterApi {

    private final PeriodicReportQuarterService periodicReportQuarterService;

    @Autowired
    public PeriodicReportQuarterApi(PeriodicReportQuarterService periodicReportQuarterService) {
        this.periodicReportQuarterService = periodicReportQuarterService;
    }
    ...
    public List<PeriodicReportQuarterDTO> getDataSource() {
        return periodicReportQuarterService.listPeriodicReportQuarter();
    }
    ...
    public Boolean executeTransTask() {
        return periodicReportQuarterService.executeTransTask();
    }
    ...
    public Boolean modifyOtherReport(@RequestBody JsonRequest jsonRequest) {
        return periodicReportQuarterService.updateReport(jsonRequest.getId(), jsonRequest.getParams());
    }
    ...
    public Boolean saveOtherReport(@RequestBody JsonRequestCollection jsonRequest) {
        return periodicReportQuarterService.saveReport(jsonRequest.getParams());
    }
    ...
    public Boolean deleteOtherReport(@PathVariable String bizId) {
        return periodicReportQuarterService.deleteReport(bizId);
    }
    ...
    public Boolean executeGenerateTask(@RequestParam("operation") String operation) {
        ...
        String dir = periodicReportQuarterService.executeGenerateTask(operationEnum);
        //清空xml
