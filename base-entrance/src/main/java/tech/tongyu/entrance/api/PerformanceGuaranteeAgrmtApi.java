 ...
 */
@RestController
@RequestMapping("performance-guarantee")
public class PerformanceGuaranteeAgrmtApi {

    private final PerformanceAgrmtService performanceGuaranteeAgrmtService;

    @Autowired
    public PerformanceGuaranteeAgrmtApi(PerformanceAgrmtService performanceGuaranteeAgrmtService) {
        this.performanceGuaranteeAgrmtService = performanceGuaranteeAgrmtService;
    }
    ...
    public List<PerformanceGuaranteeAgrmtDTO> getDataSource() {
        return performanceGuaranteeAgrmtService.listPerformanceGuaranteeAgrmt();
    }
    ...
    public Boolean executeTransTask() {
        return performanceGuaranteeAgrmtService.executeTransTask();
    }
    ...
    public Boolean modifyOtherReport(@RequestBody JsonRequest jsonRequest) {
        return performanceGuaranteeAgrmtService.updateReport(jsonRequest.getId(), jsonRequest.getParams());
    }
    ...
    public Boolean saveOtherReport(@RequestBody JsonRequestCollection jsonRequest) {
        return performanceGuaranteeAgrmtService.saveReport(jsonRequest.getParams());
    }
    ...
    public Boolean deleteOtherReport(@PathVariable String bizId) {
        return performanceGuaranteeAgrmtService.deleteReport(bizId);
    }
    ...
    public Boolean executeGenerateTask(@RequestParam("operation") String operation) {
        ...
        String dir = performanceGuaranteeAgrmtService.executeGenerateTask(operationEnum);
        //清空xml
