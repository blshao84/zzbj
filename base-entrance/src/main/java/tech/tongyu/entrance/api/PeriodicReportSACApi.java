 ...
 */
@RestController
@RequestMapping("pr-sac")
public class PeriodicReportSACApi {

    private final PeriodicReportSACService periodicReportSACService;

    @Autowired
    public PeriodicReportSACApi(PeriodicReportSACService periodicReportSACService) {
        this.periodicReportSACService = periodicReportSACService;
    }
    ...
    public List<PeriodicReportSACDTO> getDataSource() {
        return periodicReportSACService.listPeriodicReportSAC();
    }
    ...
    public Boolean executeTransTask() {
        return periodicReportSACService.executeTransTask();
    }
    ...
    public Boolean modifyOtherReport(@RequestBody JsonRequest jsonRequest) {
        return periodicReportSACService.updateReport(jsonRequest.getId(), jsonRequest.getParams());
    }
    ...
    public Boolean saveOtherReport(@RequestBody JsonRequestCollection jsonRequest) {
        return periodicReportSACService.saveReport(jsonRequest.getParams());
    }
    ...
    public Boolean deleteOtherReport(@PathVariable String bizId) {
        return periodicReportSACService.deleteReport(bizId);
    }
    ...
    public Boolean executeGenerateTask(@RequestParam("operation") String operation) {
        ...
        String dir = periodicReportSACService.executeGenerateTask(operationEnum);
        //清空xml
