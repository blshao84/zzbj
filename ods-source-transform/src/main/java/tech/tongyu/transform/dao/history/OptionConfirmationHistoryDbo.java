...
import static tech.tongyu.core.constant.ServiceConstant.OPTION_CONFIRMATION_HISTORY;
 ...
 **/
@Entity
@Table(schema = HISTORY_DATA, name = OPTION_CONFIRMATION_HISTORY)
@TypeDef(name = "JsonNodeType", typeClass = JsonNodeType.class)
public class OptionConfirmationHistoryDbo extends BaseEntity {
    ...
    public OptionConfirmationHistoryDbo() {
    }

    public OptionConfirmationHistoryDbo(JsonNode report, String bizId) {
        this.report = report;
        this.bizId = bizId;
    }
