...
/**
 * @Author javier
 * @Description 保留4位小数, 同时总的字符长度不能超过20, 即整数位最多可为15位；
 */
@Component
public class FourDecimal20LenCheck implements CheckAction {
    @Override
    public String getCheckName() {
        return "保留4位小数,同时总的字符长度不能超过20,即整数位最多可为15位";
    }
    ...
    public Object execute(Map<String, Object> data, String elementName) {
        ...
        try {
            ...
            number = number.setScale(4, BigDecimal.ROUND_HALF_UP);
        } catch (Exception e) {
