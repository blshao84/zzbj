package tech.tongyu.core.dto.optiontermination;
...
@JsonPropertyOrder({"ExceID", "BizID", "ConfirmationNo", "ExpirationDate", "DefaultingParty",
        "DefaultEvent", "RenewalDate", "DurationOperationType", "TerminationAmount", "Balance", "AmountPaidThisTime"})
public class OptionTerminationDTO extends RequestCommon {
    ...
    public static OptionTerminationDTO fromJson(JsonNode json) {
        return fromJson(json, Optional.empty());
    }

    public static OptionTerminationDTO fromJson(JsonNode json, Optional<OperationEnum> op) {
        OptionTerminationDTO dto = JsonUtils.mapper.convertValue(json, OptionTerminationDTO.class);
        // 选展期时，该字段不能填
    ...
    private static void removeNullableFields(OptionTerminationDTO dto) {
    ...
    public OptionTerminationDTO() {
    }

    public OptionTerminationDTO(String confirmationNo, String expirationDate, String defaultingParty, String defaultEvent, String renewalDate, String durationOperationType, String terminationAmount, String balance, String amountPaidThisTime) {
