...
def test_a1001_add():
    ...
    zip_xml_path = os.path.join(parent_dir, '../dist/A1001/A/OTC_000023_000020_' + today_no_dash + '_0001_A1001_A.xml')
    ...
    zip_pdf_path = os.path.join(parent_dir, '../dist/A1001/A/ATTACHMENT/A100101.pdf')
