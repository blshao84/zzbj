...
CODE = 'A1013'
CODE_ADDITIONAL1 = 'A1013.1'
CODE_ADDITIONAL2 = 'A1013.2'


def build_isda_data(main, additional_list1, additional_list2, main_filter_cols=None,
    ...
    # 标的情况与对冲
    main['TargetCaseAndHedgeTuple'] = utils.filter_field(additional_list2, additional_filter_cols2)
